...
export const ToggleUnitsAugmentsSwitch = ({
  toggleUnitsOrAugments,
  setToggleUnitsOrAugments,
}: ToggleUnitsAugmentsSwitchProps) => (
  <div className="flex items-center gap-2">
    <p className={`text-xs ${!toggleUnitsOrAugments ? 'text-gray-400' : ''}`}>Units</p>
    <div
    ...
    <p className={`text-xs ${toggleUnitsOrAugments ? 'text-gray-400' : ''}`}>Augments</p>
  </div>
);
