  ...
  return (
    <div className="bg-mainBackground h-30 ">
      <div className="align-middle text-center pt-5">
        <FontAwesomeIcon
          icon={faGithub}
          className="text-white text-xl px-3 h-7 w-7 hover:cursor-pointer"
        ...
        <FontAwesomeIcon
          icon={faPaypal}
          className="text-white text-xl px-3 h-7 w-7 hover:cursor-pointer"
          onClick={() => (window.location.href = 'http://Paypal.com')}
        />
        <FontAwesomeIcon
          icon={faTwitch}
          className="text-white text-xl px-3 h-7 w-7 hover:cursor-pointer"
          onClick={() => (window.location.href = 'http://Twitch.com')}
        />
      </div>
      ...
      <p className="text-white text-[10px] text-center">
        © 2023 - 2025 TFTStratify. TFTStratify isn't endorsed by Riot Games and doesn't reflect the
        views or opinions of Riot Games or anyone officially involved in producing or <br />{' '}
