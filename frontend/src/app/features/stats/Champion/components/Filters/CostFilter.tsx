  ...
  return (
    <div className="flex flex-row justify-center items-center gap-2">
      {[1, 2, 3, 4, 5, 6].map((costValue) => (
        <div
          key={costValue}
          className={`flex flex-row items-center justify-center cursor-pointer rounded-xl w-[4rem] h-[2rem] bg-[#1e1d1d] hover:bg-[#3a3838] gap-1 border border-${getCostBorderColors(costValue)} ${setOpacity(costValue)}`}
