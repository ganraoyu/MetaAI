export const champions = [
  {
    ...
    abilityDescription:
      "Passive: Amumu reduces all incoming damage. Every second, emit sparks that deal magic damage to adjacent enemies. Damage Reduction: 12/15/25 Damage: 10/15/25 AP",
    range: 5,
    mana: 1,
    manaPerAttack: 0,
    abilityManaCost: 70,
  ...
  },
  {
    ...
    abilityName: "Obsolete Technology",
    abilityDescription:
      "Passive: After surviving damage, deal 0.03% of the damage absorbed as magic damage to target. Active: Blitzcrank gains a Shield for 4 seconds. Shock the nearest 3 enemies for magic damage and reduce their damage by 0.1% for 4 seconds. Shield: 450/470/520 AP Damage: 40/60/100 AP",
  },
  {
    name: "Caitlyn",
    cost: 5,
  ...
  },
  {
    ...
    abilityDescription:
      "Cassiopeia blasts a target and deals magic damage. Every third cast, splash miasma to 2 enemies within 3 hexes, dealing magic damage to each. Damage: 230/345/550 AP Third Cast Damage: 160/240/385 AP",
  },
  {
    name: "Ekko",
    cost: 4,
    ...
    abilityDescription:
      "Summon an assault of afterimages that deals magic damage to the target and magic damage to other nearby enemies. Afterimages reduce their target's Magic Resist by 5 for the rest of combat. Damage: 285% / 430% / 1200% (AP). Secondary Damage: 145% / 215% / 400% (AP). Additional Targets: 2 / 2 / 4.",
  },
  {
    name: "Elise",
    cost: 4,
    ...
    abilityName: "Cocoon",
    abilityDescription:
      "Elise jumps to a nearby hex and web all enemies within 2 hexes, stunning them for some seconds and dealing magic damage and healing herself Stun: 1.75/2/8 sec Melee Damage: 120/180/1200% AP Melee Heal: 400/450/2000% AP Ranged Damage: 220/330/1000% AP Secondary Damage: 90/135/400% AP",
  },
  {
    name: "Heimerdinger",
    cost: 4,
  ...
  },
  {
    ...
    abilityDescription:
      "Ezreal fires a shot towards current target that deals physical damage to all enemies within 1 hex. Then, deal physical damage to the unit in the center of the blast. Damage: 1.4 + 20/30/50 AD Center Damage: 1.4 + 20/30/50 AD",
  },
  {
    name: "Gangplank",
    cost: 3,
  ...
  },
  {
    ...
    abilityDescription:
      "Camille kicks the target, dealing Adaptive Damage. Heal for 0.4% of the damage dealt.Adaptive Damage: Uses the damage type the target resists less Adaptive Damage: 245/245/265%",
  },
  {
    name: "Rell",
    cost: 2,
  ...
  },
  {
    ...
    abilityDescription:
      "Passive: If Draven has an empowered axe in hand, it replaces his next attack, dealing physical damage. Empowered axes return to Draven after hitting an enemy. Active: Spin an empowered axe. Damage: 10% / 15% / 25% (AP) + 140% / 140% / 150% / 150% (AD)",
  },
  {
    name: "Lux",
    cost: 1,
