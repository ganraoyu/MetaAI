...
export const radiantItems = [
    ...
    new Item({
        ...
        description: 'Physical damage 30% Sunders the target for the rest of combat. This effect does not stack.',
    ...
    new Item({
        ...
        additionalDamageAmp: 0.50, // 50% more damage
    }),
    new Item({
        name: 'Dragon\'s Will',
    ...
    new Item({
        name: 'Rosethorn Vest',
        description: 'Gain 15% max health. Take 25% reduced damage from attacks. When struck by any attack, deal 175 magic damage to all adjacent enemies. (Cooldown: 2 seconds)',
    ...
    new Item({
        ...
        additionalAttackDamage: 1.30, // 30% more attack damage
    }),
    new Item({
        name: 'Titan\'s Vow',
    ...
    new Item({
        ...
        description: 'Gain 15 Armor and 15 Magic Resist for each enemy targeting the holder. Also, heal 1.5% max Health each second.',
    ...
    new Item({
        ...
        description: 'Combat start: Shields the holder for 50% of their max health for 8 seconds. When the shield breaks or expires, gain 50 Ability Power.',
        additionalAbilityPower: 40, // 40 ability power
        additionalArmor: 40, // 40 more armor
        additionalHealth: 200, // 200 more health
        shield: true,
        shieldAmount: 0.50, // 50% max health shield
        shieldDuration: 8, // 8 seconds
    }),
    new Item({
    ...
    new Item({
        name: 'Bulwark\'s Oath',
        description: 'Once per combat at 40% Health, gain a 50% max Health Shield that lasts 10 seconds and gain 60 Armor and 60 Magic Resist.',
        additionalArmor: 40, // 40 more armor
    ...
    new Item({
        name: 'Sunlight Cape',
        description: 'Gain 12% max Health. Every 1.5 seconds, deal 2% Burn and 33% Wound to an enemy within 3 hexes for 8 seconds.',
        additionalArmor: 40, // 40 more armor
    ...
    new Item({
        name: 'Covalent Spark',
        description: '30% Shred enemies within 3 hexes. When enemies cast an Ability, deal magic damage equal to 200% of the Mana spent. Also, heal 1.5% max Health per second.',
        additionalHealth: 200, // 200 more health
        additionalAbilityPower: 15, // 15 ability power
        shred: true,
        heal: true,
    ...
    new Item({
        ...
        description: 'Combat start: Gain different bonuses based on starting position. Front Two Rows: 60 Armor and Magic Resist. Gain 2 Mana when struck by an attack. Back Two Rows: 40 Ability Power. Gain 20 Mana every 3 seconds.',
        additionalStartingMana: 15, // 15 starting mana
        additionalAbilityPower: 25, // 25 ability power
    }),
    new Item({
        name: 'Equinox',
        description: '30% Sunder enemies within 3 hexes. Gain 70 Armor and Magic Resist for the first 20 seconds of combat.',
        additionalHealth: 500, // 500 more health
        sunder: true,
    }),
    new Item({
        name: 'Absolution',
        description: 'Heal allies within 2 hexes for 25% of their missing Health every 5 seconds. They also gain 10% Durability for 5 seconds (this does not stack).',
        additionalStartingMana: 15, // 15 starting mana
        additionalHealth: 400, // 400 more health
        heal: true,
    }), 
    ...
    new Item({
        name: 'Quickestsilver',
        description: 'Combat start: Gain immunity to crowd control for 45 seconds. For 18 seconds, gain 7% Attack Speed every 2 seconds.',
        additionalAttackSpeed: 1.5, // 50% attack speed
        additionalCritChance: 0.4, // 40% crit chance
    }),
    new Item({
        name: 'Blue Blessing',
        description: 'Gain 10 Mana after casting. When the holder gets a takedown, they deal 20% more damage for 12 seconds.',
        additionalAbilityPower: 60, // 60 ability power
        additionalStartingMana: 30, // 30 starting mana
        additionalAttackSpeed: 1.6, // 60% attack speed
    })
