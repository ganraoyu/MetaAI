...
const champions = [
  {
    ...
    statsByStarLevel: {
      1: {
        ...
        armor: 35,
        magicResist: 35,
        ability: { reduction: 12, damage: 0, magicDamage: 110, healing: 0 },
      },
      2: {
        hp: 1080,
        attackDamage: 68,
        armor: 35,
        magicResist: 35,
        ability: { reduction: 15, damage: 0, magicDamage: 150, healing: 0 },
      },
      3: {
        hp: 1944,
        attackDamage: 101,
        armor: 50,
        magicResist: 60,
        ability: { reduction: 25, damage: 0, magicDamage: 200, healing: 0 },
      },
    },
    attackSpeed: 0.6,
